export const dict = {
  ...
  "dialog.plugins.empty": "mimocode.json에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(mimocode.json)의 공급자/모델 이름을 확인하세요",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "검토 및 파일",
  ...
  "sidebar.empty.description": "프로젝트를 열어 시작하세요",  "sidebar.workspaces.enable": "작업 공간 활성화",
