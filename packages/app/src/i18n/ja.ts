export const dict = {
  ...
  "dialog.plugins.empty": "mimocode.jsonで設定されたプラグイン",
  ...
  "error.chain.checkConfig": "config (mimocode.json) のプロバイダー/モデル名を確認してください",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "レビューとファイル",
  ...
  "sidebar.settings": "設定",
  "sidebar.help": "ヘルプ",
  "sidebar.empty.title": "開いているプロジェクトがありません",
  "sidebar.empty.description": "プロジェクトを開いて開始しましょう",  "sidebar.workspaces.enable": "ワークスペースを有効化",
