...
export const dict = {
  ...
  "dialog.plugins.empty": "在 mimocode.json 中設定的外掛程式",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (mimocode.json) 中的 provider/model 名稱",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "審查與檔案",
  ...
  "sidebar.empty.description": "開啟一個專案開始使用",  "sidebar.workspaces.enable": "啟用工作區",
