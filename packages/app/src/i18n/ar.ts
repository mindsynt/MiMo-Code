export const dict = {
  ...
  "dialog.plugins.empty": "الإضافات المكونة في mimocode.json",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (mimocode.json)",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "المراجعة والملفات",
  ...
  "sidebar.empty.description": "افتح مشروعًا للبدء",  "sidebar.workspaces.enable": "تمكين مساحات العمل",
