export const dict = {
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w mimocode.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (mimocode.json) nazwy dostawców/modeli",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Przegląd i pliki",
  ...
  "sidebar.empty.description": "Otwórz projekt, aby rozpocząć",  "sidebar.workspaces.enable": "Włącz przestrzenie robocze",
