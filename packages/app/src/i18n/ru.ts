export const dict = {
  ...
  "dialog.plugins.empty": "Плагины настроены в mimocode.json",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (mimocode.json)",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Обзор и файлы",
  ...
  "sidebar.empty.description": "Откройте проект, чтобы начать",  "sidebar.workspaces.enable": "Включить рабочие пространства",
