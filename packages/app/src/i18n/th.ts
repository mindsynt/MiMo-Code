export const dict = {
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน mimocode.json",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (mimocode.json) ชื่อผู้ให้บริการ/โมเดล",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "ตรวจสอบและไฟล์",
  ...
  "sidebar.empty.description": "เปิดโปรเจกต์เพื่อเริ่มต้น",  "sidebar.workspaces.enable": "เปิดใช้งานพื้นที่ทำงาน",
