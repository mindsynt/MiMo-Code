export const dict = {
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u mimocode.json",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (mimocode.json) provider/model names",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Pregled i datoteke",
  ...
  "sidebar.empty.description": "Otvorite projekat da biste počeli",  "sidebar.workspaces.enable": "Omogući radne prostore",
