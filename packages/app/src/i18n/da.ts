export const dict = {
  ...
  "dialog.plugins.empty": "Plugins konfigureret i mimocode.json",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (mimocode.json) udbyder/modelnavne",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Gennemgang og filer",
  ...
  "sidebar.empty.description": "Åbn et projekt for at komme i gang",  "sidebar.workspaces.enable": "Aktiver arbejdsområder",
