export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en mimocode.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (mimocode.json)",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Revisión y archivos",
  ...
  "sidebar.empty.description": "Abre un proyecto para comenzar",  "sidebar.workspaces.enable": "Habilitar espacios de trabajo",
