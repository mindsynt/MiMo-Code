export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans mimocode.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (mimocode.json) pour les noms de fournisseur/modèle",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Revue et fichiers",
