...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler mimocode.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (mimocode.json) sağlayıcı/model adlarını kontrol edin",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "İnceleme ve dosyalar",
  ...
  "sidebar.empty.description": "Başlamak için bir proje açın",  "sidebar.workspaces.enable": "Çalışma alanlarını etkinleştir",
