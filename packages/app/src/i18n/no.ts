...
export const dict = {
  ...
  "dialog.plugins.empty": "Plugins konfigurert i mimocode.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (mimocode.json)",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Gjennomgang og filer",
  ...
  "sidebar.empty.description": "Åpne et prosjekt for å komme i gang",  "sidebar.workspaces.enable": "Aktiver arbeidsområder",
