export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados em mimocode.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (mimocode.json)",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Revisão e arquivos",
  ...
  "sidebar.empty.description": "Abra um projeto para começar",  "sidebar.workspaces.enable": "Habilitar espaços de trabalho",
