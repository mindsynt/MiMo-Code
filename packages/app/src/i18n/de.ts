...
export const dict = {
  ...
  "dialog.plugins.empty": "In mimocode.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (mimocode.json) auf Anbieter-/Modellnamen",
  ...
  "session.tasks.status.cancelled": "Cancelled",  "session.panel.reviewAndFiles": "Überprüfung und Dateien",
  ...
  "sidebar.help": "Hilfe",
  "sidebar.empty.title": "Keine offenen Projekte",
  "sidebar.empty.description": "Öffnen Sie ein Projekt, um loszulegen",  "sidebar.workspaces.enable": "Arbeitsbereiche aktivieren",
