...
export const dict = {
  ...
  "voice.test": "测试麦克风",
  "voice.stop.test": "停止",
  "voice.error.noDevice": "未找到麦克风",
  "voice.browserNotSupported": "当前浏览器不支持语音输入",
  "voice.browserHint": "语音识别需要 Chrome、Edge 或 Safari 浏览器，Firefox 支持即将到来。",
  ...
  "dialog.plugins.empty": "在 mimocode.json 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (mimocode.json) 中的 provider/model 名称",
