export const dict = {
  ...
  "voice.stop.test": "Stop",
  "voice.error.noDevice": "No microphone found",
  "voice.browserNotSupported": "Voice input not supported",
  "voice.browserHint": "Speech recognition requires Chrome, Edge, or Safari. Firefox support coming soon.",
  ...
  "dialog.plugins.empty": "Plugins configured in mimocode.json",
  ...
  "error.chain.checkConfig": "Check your config (mimocode.json) provider/model names",
